...
public class LineCode : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lineRenderer.startWidth = 0.11f; // this is the starting point width of the line renderer
        lineRenderer.endWidth = 0.11f; // this is the ending point width of the line renderer
    }
